...
Current package version: **0.4.116**.

| Role | Operating system | Package |
|---|---|---|
| Server full node | Linux x64 | [Download](packages/SaccadiaRemote-Server-0.4.116-linux-x64.tar.gz) |
| Edge only | Linux x64 | [Download](packages/SaccadiaRemote-Edge-0.4.116-linux-x64.tar.gz) |
| ServerRelay only | Linux x64 | [Download](packages/SaccadiaRemote-ServerRelay-0.4.116-linux-x64.tar.gz) |
| Server full node | Windows x64 | [Download](packages/SaccadiaRemote-Server-0.4.116-windows-x64.zip) |
| Edge only | Windows x64 | [Download](packages/SaccadiaRemote-Edge-0.4.116-windows-x64.zip) |
| ServerRelay only | Windows x64 | [Download](packages/SaccadiaRemote-ServerRelay-0.4.116-windows-x64.zip) |
...
sudo tar -xzf SaccadiaRemote-Server-0.4.116-linux-x64.tar.gz \
...
sudo tar -xzf SaccadiaRemote-ServerRelay-0.4.116-linux-x64.tar.gz \
