...
|---|---|---|
| Server full node | Linux x64 | [Download](packages/SaccadiaRemote-Server-0.3.9-linux-x64.tar.gz) |
| Edge only | Linux x64 | [Download](packages/SaccadiaRemote-Edge-0.3.9-linux-x64.tar.gz) |
| Server full node | Windows x64 | [Download](packages/SaccadiaRemote-Server-0.3.9-windows-x64.zip) |
| Edge only | Windows x64 | [Download](packages/SaccadiaRemote-Edge-0.3.9-windows-x64.zip) |
...
sudo tar -xzf SaccadiaRemote-Server-0.3.9-linux-x64.tar.gz \
